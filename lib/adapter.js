// Extend `socket.io-redis` to:
//  - Use official `msgpack` package for `msgpack-ruby` compatability.
//  - Implement custon flag for injecting messages into Redis.
...
function adapter(uri, opts){
  ...
  Redis.prototype.onmessage = function(channel, msg){
    ...
    if (args[1] !== undefined && args[1].flags !== undefined) {
      flags = args[1].flags;
    }
    ...
    // Check for our custom emit flag to rebroadcast packets
    if (!flags || flags.emit !== true) {
      args.push(true);
    }
